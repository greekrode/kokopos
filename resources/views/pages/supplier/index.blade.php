    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h3 class="card-title float-left mb-3">Data Supplier</h3>
                        <a class="card-title btn btn-primary float-right mb-3" href="{{ route('supplier.create') }}"><i class="mdi mdi-plus"></i> Tambah Baru</a>
