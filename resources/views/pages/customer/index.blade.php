    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h3 class="card-title float-left mb-3">Data Konsumen</h3>
                        <a class="card-title btn btn-primary float-right mb-3" href="{{ route('customer.create') }}"><i class="mdi mdi-plus"></i> Tambah Data</a>
                        <div class="table-responsive">
                            ...
                            <table id="zero_config" class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <th class="font-22 font-bold">No HP</th>
