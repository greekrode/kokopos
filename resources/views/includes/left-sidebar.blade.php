        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav" class="p-t-30">
                ...
                @if (Auth::user()->role === 'admin')
                    ...
                    <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link {{Request::segment(1) === 'report' ? 'active' : ''}}" href="{{ route('report.index') }}" aria-expanded="false"><i class="mdi mdi-paperclip"></i><span class="hide-menu">Report</span></a></li>
                @endif
