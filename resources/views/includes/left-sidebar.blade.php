    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav" class="p-t-30">
                ...
                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link {{Request::route()->getName() === 'category' ? 'active' : ''}}" href="{{ route('category') }}" aria-expanded="false"><i class="mdi mdi-database"></i><span class="hide-menu">Category</span></a></li>
